...
# Bonus 1 
Σε συνεργασία με την <a href="https://github.com/cgalani">Χριστίνα Γαλάνη</a> και την <a href="https://github.com/Kuletsi">Ελένη Κουλέτση</a>
------------------------------------
...
Για το πρώτο παραδοτέο, μπήκαμε στο βιβλίο για να δούμε το παράδειγμα. Τρέξαμε το παράδειγμα για να δούμε ότι δουλεύει κανονικά. Δούλευε κανονικά. Στην συνέχεια πήραμε το <a href="http://learningprocessing.com/examples/chp09/example-09-08-mouse-history">παράδειγμα 9-8</a>, όπως και τους δικούς μας κωδικές από το αντίστοιχο κομμάτι του παραδοτέου 2, τα συνδυάσαμε και τα τρέξαμε. Να σημειωθεί πως κάπου στην πορεία σταμάτησε να μας δουλεύει η κάμερα και ψάχναμε άλλον υπολογιστή(παλι)(κάποιος μας ματιασε μάλλον).
 ...
 ![211913862-fff880da-2277-49f0-a2b2-c5e2bdc785de](https://user-images.githubusercontent.com/101420117/212413782-aaeb75c8-12b1-4091-82aa-3ef0c3bbf7e5.mp4) <br>
...
![211913838-66088c8e-f070-423c-9f54-35dfafca8303](https://user-images.githubusercontent.com/101420117/212414230-dd0ef349-b1cc-46e8-ba05-1b7be4fe1c14.mp4) <br>
...
# Bonus 2 <br>
Σε συνεργασία με την <a href="https://github.com/cgalani">Χριστίνα Γαλάνη</a> και τhν <a href="https://github.com/Kuletsi">Ελένη Κουλέτση</a> 
-------------------------------------------------------------
