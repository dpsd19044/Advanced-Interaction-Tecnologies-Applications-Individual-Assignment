...
# Conclusions
Στα αρχικά παραδοτέα όπου υπήρχε η απαίτηση χρήσης κάμερα δεν μπορουσα να τα υλοποιήσω ολοκληρωτικά αφου στο λάπτοπ μου αλλα και στον Υπολογιστή της σχολής μου έβγαζε errors ότι έπρεπε να έχω κατεβάσει αρχεία για 32bit ένω και τα δύο υποστηρίζουν αρχεία 64bit. Παρόλα αυτά κατάφερα να υλοποιήσω πιο ολοκληρωμένο το 3 παραδοτέο. Το processing θέλει αρκετή οργάνωση στους φακέλους που είναι τα αρχεία των βιβλιοθηκών και του κάθε project. 
